...
namespace Utils.Web
{
    ...
    public class QueryString : Dictionary<string, string>
    {
        ...
        public QueryString Add(string name, string value, bool isUnique)
        {
            ...
            base.TryGetValue(name, out existingValue);
        ...
        public new string this[string name]
        {
            get
            {
                return WebUtility.UrlDecode(base[name]);
            }
        }
        ...
        public override string ToString()
        {
            ...
            foreach (var pair in this)
            {
                ...
                {
                    foreach (string val in pair.Value.Split(','))
                        builder.Append((builder.Length == 0) ? String.Empty : "&").Append(WebUtility.UrlEncode(pair.Key)).Append("=").Append(val);
                }
            }
